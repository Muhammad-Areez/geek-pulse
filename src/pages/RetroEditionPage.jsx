                ...
                <Col md={6}>
                  <div className="retro-sec-right">
                    <motion.h3
                      ...
                      viewport={{ once: true }}
                    >
                      Turn back time with a modern twist. The Retro Edition
                      brings nostalgic vibes to the future of vaping, bold
                      design, vibrant colours, and three classic flavours that
                      hit just right. It’s a tribute to the golden era,
                      reimagined for today’s generation of Pulse lovers.
                    </motion.h3>
                    <motion.img
          ...
          <SwiperSlide>
            <div className="retro-sec">
              <Row>
                ...
                <Col md={6}>
                  <div
                    className="retro-sec-right"
                    style={{ background: "#F46CFE" }}
                  >
                    <motion.h3
                      initial={{ x: 100, opacity: 0 }}
                      whileInView={{ x: 0, opacity: 1 }}
          ...
          <Row className="retro-product-row">
            <Col md={3} sm={6} xs={6}>
              <div className="retro-product-card">
                ...
                <div className="retro-product-img-main">
                  <img
                    src={images.retroProductVector1}
                    alt="vector"
                    className="retro-product-vector1"
                  />
                  <img
                    src={images.retroProductVector2}
                    alt="vector"
                    className="retro-product-vector2"
                  />
                  <motion.img
                  ...
                  />
                  <img
                    src={images.retroBox2}
                    alt="box"
                    className="retro-box-img"
                  />
                </div>
              </div>
            </Col>
            <Col md={3} sm={6} xs={6}>
              <div className="retro-product-card">
                ...
                <div className="retro-product-img-main">
                  <img
                    src={images.retroProductVector3}
                    alt="vector"
                    className="retro-product-vector1"
                  />
                  <motion.img
              ...
              <div className="retro-product-card">
                ...
                <div className="retro-product-img-main">
                  <img
                    src={images.retroProductVector1}
                    alt="vector"
                    className="retro-product-vector3"
                  />
                  <motion.img
